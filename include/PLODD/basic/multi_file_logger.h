...
////////////////////////////////////////////////////////////////////////////////
/// @brief A multi-file file logger that logs to three files.
///
/// @details A multi-sink file logger that outputs into three files:
/// `debug.log`, `main.log`, and `errors.log`. `debug.log` is written all logs
/// no matter the logging level that is set on a per-logger basis. `main.log` is
/// only written all the logs of equal or greater logging level. i.e. only
/// `WARNING` and `ERROR` if the level is set to `WARNING` and not `INFO` and
/// `DEBUG`. `errors.log` is only written logs that are of the `ERROR` logging
/// level.
////////////////////////////////////////////////////////////////////////////////
class PLODD_API multi_file_logger : public base_logger {
    ...
    public:
        ////////////////////////////////////////////////////////////////////////////////
        /// @brief Constructs a new multi-file logger object and initializes the
        /// output files.
        /// @param output_directory_path The path to the directory where the
        /// output files are placed.
        /// @param logger_name The name of the logger.
        /// @param logger_level The minimum logging level at which the logger
        /// will write output.
        ////////////////////////////////////////////////////////////////////////////////
